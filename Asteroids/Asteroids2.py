...
def asteroidAction(asteroid):
	...
	if ship.rotated_image_center[0] > asteroid.x and ship.rotated_image_center[0] < asteroid.x + 70:
		if ship.rotated_image_center[1] > asteroid.y and ship.rotated_image_center[1] < asteroid.y + 70:
			run = False
	for bullet in bullets:
